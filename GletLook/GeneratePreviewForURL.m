...
OSStatus GeneratePreviewForURL(void *thisInterface, QLPreviewRequestRef preview, CFURLRef url, CFStringRef contentTypeUTI, CFDictionaryRef options)
{
    ...
    // Get icon and html file from qlgenerator bundle
	...
	NSString *htmlFile = [NSString stringWithContentsOfURL:(NSURL*)htmlUrl encoding:NSUTF8StringEncoding error:&error];
